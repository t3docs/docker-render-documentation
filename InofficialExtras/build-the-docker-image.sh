...
# Examples:
#     cd InofficialExtras
#     VERSION=v1.6.11-html ./build-the-docker-image.sh
#     VERSION=v1.6.11-html OUR_IMAGE_TAG=latest DOCKRUN_PREFIX="dockrun_" ./build-the-docker-image.sh
#     VERSION=v1.6.11-html DOCKRUN_PREFIX="ddockrun_" ./build-the-docker-image.sh
