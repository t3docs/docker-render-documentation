...
# Examples:
#     cd InofficialExtras
#     VERSION=v1.6.10-dev-full ./build-the-docker-image.sh
#     VERSION=v1.6.10-dev-full DOCKRUN_PREFIX="dockrun_" ... ./build-the-docker-image-html.sh
...
# variables 1
VERSION=${VERSION:-"v1.6.10-dev-full"}
